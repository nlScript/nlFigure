...
public class CustomImageCanvas extends Canvas implements MouseListener, MouseMotionListener, Cloneable {
	...
	public CustomImageCanvas(ImagePlus imp) {
		this.imp = imp;
	...
	void update(CustomImageCanvas ic) {
